...
<style>
    .home_image_container {
        position: relative;
        width: 100%;
        height: 100vh; /* imagen en pantalla completa */
        overflow: hidden;
    }
    ...
    .home_image_background {
        ...
        filter: brightness(65%); /* oscurecer un poco la imagen para ver el formulario */
    }
...
<div class="super_container">
	...
	<div class="home">
        <div class="home_image_container">
            <div class="home_image_background"
                style="background-image: url('{{ asset('travelix/images/home_slider.jpg') }}');">
            </div>
